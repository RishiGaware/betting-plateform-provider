! function(t, e) {
    ...
    var d = {
            ...
            scrollingClass: "has-scroll-scrolling2",
            draggingClass: "has-scroll-dragging2",
            smoothClass: "has-scroll-smooth2",
            initClass: "has-scroll-init2",
            getSpeed: !1,
            getDirection: !1,
            multiplier: 1,
            ...
            return i(e, [{
                ...
                value: function(t) {
                    ...
                    this.els.forEach((function(n, o) {
                        !n || n.inView && !t || s >= n.top && i < n.bottom && e.setInView(n, o), n && n.inView && (s < n.top || i > n.bottom) && e.setOutOfView(n, o)
    ...
    var v = y((function(t, e) {
                ...
                polyfill: function() {
                    ...
                    if (!("scrollBehavior" in e.documentElement.style) || !0 === t.__forceSmoothScrollPolyfill__) {
                        ...
                        t.scroll = t.scrollTo = function() {
                            ...
                            void 0 !== arguments[0] && (c(arguments[0]) ? o.scrollBy.call(t, void 0 !== arguments[0].left ? arguments[0].left : "object" != typeof arguments[0] ? arguments[0] : 0, void 0 !== arguments[0].top ? arguments[0].top : void 0 !== arguments[1] ? arguments[1] : 0) : f.call(t, e.body, ~~arguments[0].left + (t.scrollX || t.pageXOffset), ~~arguments[0].top + (t.scrollY || t.pageYOffset)))
                            ...
                            if (!0 !== c(arguments[0])) {
                                var i = function(t) {
                                        for (; t !== e.body && !1 === (s = h(i = t, "Y") && u(i, "Y"), n = h(i, "X") && u(i, "X"), s || n);) t = t.parentNode || t.host;
                                        var i, s, n;
                                        return t
                                    }(this),
                                    s = i.getBoundingClientRect(),
                                    n = this.getBoundingClientRect();
                                i !== e.body ? (f.call(this, i, i.scrollLeft + n.left - s.left, i.scrollTop + n.top - s.top), "fixed" !== t.getComputedStyle(i).position && t.scrollBy({
                                    left: s.left,
                                    top: s.top,
                                    behavior: "smooth"
                                })) : t.scrollBy({
                    ...
                    function d(e) {
                        ...
                        r = a = 1 < a ? 1 : a, i = .5 * (1 - Math.cos(Math.PI * r)), s = e.startX + (e.x - e.startX) * i, o = e.startY + (e.y - e.startY) * i, e.method.call(e.scrollable, s, o), s === e.x && o === e.y || t.requestAnimationFrame(d.bind(t, e))
                    }

                    function f(i, s, n) {
                        var r, c, h, u, f = l();
                        u = i === e.body ? (c = (r = t).scrollX || t.pageXOffset, h = t.scrollY || t.pageYOffset, o.scroll) : (c = (r = i).scrollLeft, h = i.scrollTop, a), d({
                            scrollable: r,
                            method: u,
                            startTime: f,
                            startX: c,
        ...
        m = (v.polyfill, function(e) {
            function s() {
                var e, i = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};
                return t(this, s), e = c(this, l(s).call(this, i)), window.addEventListener("scroll", e.checkScroll, !1), v.polyfill(), e
            }
            return o(s, f), i(s, [{
                key: "init",
                value: function() {
                    this.instance.scroll.y = window.pageYOffset, this.addElements(), this.detectElements(), h(l(s.prototype), "init", this).call(this)
                }
            }, {
                key: "checkScroll",
                value: function() {
                    var t = this;
                    h(l(s.prototype), "checkScroll", this).call(this), this.getDirection && this.addDirection(), this.getSpeed && (this.addSpeed(), this.timestamp = Date.now()), this.instance.scroll.y = window.pageYOffset, this.els.length && (this.hasScrollTicking || (requestAnimationFrame((function() {
                        t.detectElements()
                ...
                value: function(t, e, i, s, n, o) {
                    ...
                    r = "number" != typeof l ? l.getBoundingClientRect().top + r + this.instance.scroll.y : l + r, o && (r = r.toFixed(), window.addEventListener("scroll", (function t() {
                ...
                key: "destroy",
                value: function() {
                    h(l(s.prototype), "destroy", this).call(this), window.removeEventListener("scroll", this.checkScroll, !1)
                }
            }]), s
        }()),
    ...
    var E = k,
        ...
        D = "ontouchstart" in window || window.TouchEvent || window.DocumentTouch && document instanceof DocumentTouch,
        _ = navigator.msMaxTouchPoints && 1 < navigator.msMaxTouchPoints,
    ...
    function R(t) {
        ! function(t) {
            ...
            if (0 === e.length)
                for (var i in t) j.call(t, i) && "function" == typeof t[i] && "[object Function]" == H.call(t[i]) && e.push(i);
            ...
            useKeyboard: !0,
            useTouch: !0
        }, t), this.options.limitInertia && (this._lethargy = new Y), this._emitter = new E, this._event = {
            y: 0,
            x: 0,
            deltaX: 0,
            deltaY: 0
    ...
    R.prototype._notify = function(t) {
        var e = this._event;
        e.x += e.deltaX, e.y += e.deltaY, this._emitter.emit(A, {
            x: e.x,
            y: e.y,
            deltaX: e.deltaX,
            deltaY: e.deltaY,
        ...
        if (!this._lethargy || !1 !== this._lethargy.check(t)) {
            var i = this._event;
            i.deltaX = t.wheelDeltaX || -1 * t.deltaX, i.deltaY = t.wheelDeltaY || -1 * t.deltaY, C && 1 == t.deltaMode && (i.deltaX *= e.firefoxMultiplier, i.deltaY *= e.firefoxMultiplier), i.deltaX *= e.mouseMultiplier, i.deltaY *= e.mouseMultiplier, this._notify(t)
        }
    ...
    var F = "function" == typeof Float32Array;
    ...
    function W(t, e, i) {
        return ((q(e, i) * t + z(e, i)) * t + K(e)) * t
    }

    function N(t, e, i) {
        return 3 * q(e, i) * t * t + 2 * z(e, i) * t + K(e)
    }

    function U(t) {
        return t
    }
    var $ = function(t, e, i, s) {
            if (!(0 <= t && t <= 1 && 0 <= i && i <= 1)) throw new Error("bezier x values must be in [0, 1] range");
            if (t === e && i === s) return U;
            for (var n = F ? new Float32Array(11) : new Array(11), o = 0; o < 11; ++o) n[o] = W(.1 * o, t, i);
            return function(o) {
                return 0 === o ? 0 : 1 === o ? 1 : W(function(e) {
                    for (var s = 0, o = 1; 10 !== o && n[o] <= e; ++o) s += .1;
                    var l = s + (e - n[--o]) / (n[o + 1] - n[o]) * .1,
                        r = N(l, t, i);
                    return .001 <= r ? function(t, e, i, s) {
                        for (var n = 0; n < 4; ++n) {
                            var o = N(e, i, s);
                            if (0 === o) return e;
                            e -= (W(e, i, s) - t) / o
                        ...
                        for (var o, l, r = 0; 0 < (o = W(l = e + (i - e) / 2, s, n) - t) ? i = l : e = l, Math.abs(o) > 1e-7 && ++r < 10;);
                        return l
                    }(e, s, s + .1, t, i)
                }(o), e, s)
            }
        ...
        G = function(e) {
            function s() {
                var e, i = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};
                return t(this, s), window.scrollTo(0, 0), history.scrollRestoration = "manual", (e = c(this, l(s).call(this, i))).inertia && (e.lerp = .1 * e.inertia), e.isScrolling = !1, e.isDraggingScrollbar = !1, e.isTicking = !1, e.hasScrollTicking = !1, e.parallaxElements = [], e.stop = !1, e.checkKey = e.checkKey.bind(a(e)), window.addEventListener("keydown", e.checkKey, !1), e
            }
            return o(s, f), i(s, [{
                key: "init",
                value: function() {
                    var t = this;
                    this.html.classList.add(this.smoothClass), this.instance = n({
                        delta: {
                            x: 0,
                            y: 0
                        }
                    ...
                    })), this.setScrollLimit(), this.initScrollBar(), this.addSections(), this.addElements(), this.detectElements(), this.transformElements(!0, !0), this.checkScroll(!0), h(l(s.prototype), "init", this).call(this)
                }
            }, {
                key: "setScrollLimit",
                value: function() {
                ...
                value: function() {
                    ...
                    if (0 < arguments.length && void 0 !== arguments[0] && arguments[0] || this.isScrolling || this.isDraggingScrollbar) {
                        ...
                        this.transform(this.scrollbarThumb, 0, n), h(l(s.prototype), "checkScroll", this).call(this), this.hasScrollTicking = !1
                    }
                }
            }, {
                key: "resize",
                ...
                key: "updateScroll",
                value: function(t) {
                    this.isScrolling || this.isDraggingScrollbar ? this.instance.scroll.y = X(this.instance.scroll.y, this.instance.delta.y, this.lerp) : this.instance.scroll.y > this.instance.limit ? this.setScroll(this.instance.scroll.x, this.instance.limit) : this.instance.scroll.y < 0 ? this.setScroll(this.instance.scroll.x, 0) : this.setScroll(this.instance.scroll.x, this.instance.delta.y)
                }
            }, {
                key: "addDirection",
                value: function() {
                ...
                value: function(t) {
                    ...
                    !this.isTicking && this.isDraggingScrollbar && (requestAnimationFrame((function() {
                        ...
                        0 < i && i < e.instance.limit && (e.instance.delta.y = i)
                ...
                value: function() {
                    ...
                    this.els = [], this.parallaxElements = [], this.sections.forEach((function(e, i) {
                        t.sections[i].el.querySelectorAll("[data-".concat(t.name, "]")).forEach((function(e, s) {
                            var n, o, l = e.dataset[t.name + "Class"] || t.class,
                                r = e.dataset[t.name + "Repeat"],
                                a = e.dataset[t.name + "Call"],
                            ...
                            var v = (n = t.sections[i].inView ? o.getBoundingClientRect().top + t.instance.scroll.y - I(o).y : o.getBoundingClientRect().top - I(t.sections[i].el).y - I(o).y) + o.offsetHeight,
                                m = (v - n) / 2 + n;
                            if (d) {
                                var g = e.getBoundingClientRect().top,
                                    w = g - n;
                                n += window.innerHeight, m = ((v = g + o.offsetHeight - e.offsetHeight - w) - n) / 2 + n
                            }
                            r = "false" != r && (null != r || t.repeat);
                            var b = [0, 0];
                            if (p)
                                for (var S = 0; S < p.length; S++) "string" == typeof p[S] ? p[S].includes("%") ? b[S] = parseInt(p[S].replace("%", "") * t.windowHeight / 100) : b[S] = parseInt(p[S]) : b[S] = p[S];
                            var k = {
                                el: e,
                                id: s,
                                class: l,
                ...
                value: function() {
                    ...
                    0 === e.length && (e = [this.el]), e.forEach((function(e, i) {
                        var s = e.getBoundingClientRect().top - 1.5 * window.innerHeight - I(e).y,
                    ...
                    this.parallaxElements.forEach((function(o, l) {
                        ...
                        if (t && (r = 0), o.inView || i) switch (o.position) {
                            ...
                            case "elementTop":
                                ...
                                break;
                            case "bottom":
                                r = (e.instance.limit - s + e.windowHeight) * o.speed;
                                break;
                            default:
                ...
                value: function(t, e) {
                    var i, s = this,
                        ...
                        a = e ? parseInt(e) : 0;
                    if (o = $.apply(void 0, u(o)), "string" == typeof t) {
                        if ("top" === t) i = 0;
                    ...
                    var f = parseFloat(this.instance.delta.y),
                        p = Math.max(0, Math.min(a, this.instance.limit)) - f,
                        y = function(t) {
                            l ? s.setScroll(s.instance.delta.x, f + p * t) : s.instance.delta.y = f + p * t
                        };
                    this.animatingScroll = !0, this.stopScrolling(), this.startScrolling();
                    var v = Date.now();
                    ! function t() {
                        var e = (Date.now() - v) / n;
                        1 < e ? (y(1), s.animatingScroll = !1, 0 == n && s.update(), r && r()) : (s.scrollToRaf = requestAnimationFrame(t), y(o(e)))
                    }()
                }
            }, {
                key: "update",
                ...
                key: "destroy",
                value: function() {
                    h(l(s.prototype), "destroy", this).call(this), this.stopScrolling(), this.html.classList.remove(this.smoothClass), this.vs.destroy(), this.destroyScrollBar(), window.removeEventListener("keydown", this.checkKey, !1)
                }
            }]), s
        }();
    return function() {
        function e() {
            var i = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};
            t(this, e), this.options = i, Object.assign(this, d, i), this.init()
        }
        return i(e, [{
            key: "init",
            value: function() {
                if (this.smoothMobile || (this.isMobile = /Android|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) || "MacIntel" === navigator.platform && 1 < navigator.maxTouchPoints), !0 !== this.smooth || this.isMobile ? this.scroll = new m(this.options) : this.scroll = new G(this.options), this.scroll.init(), window.location.hash) {

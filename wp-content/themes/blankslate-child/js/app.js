...
class Quadangles {
    constructor() {
        ...
        }), this.scrollProxy(), this.bindEvent();
        let e = this.isMobile();
        this.$page = new PageAnimation(e, this.$scroller)
    }
    bindEvent() {
        window.scrollTo(0, 0)
    }
    ...
    scrollProxy() {
        ...
        ScrollTrigger.scrollerProxy("#js-scroll", {
            scrollTop(o) {
                return arguments.length ? e.$scroller.scrollTo(o, 0, 0) : e.$scroller.scroll.instance.scroll.y
            },
        ...
        }), this.$scroller.on("scroll", ScrollTrigger.update), ScrollTrigger.addEventListener("refresh", (() => this.$scroller.update())), ScrollTrigger.refresh()
    }
}
new Quadangles;